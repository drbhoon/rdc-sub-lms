...
export async function GET() {
  ...
  sheet.addRow(["Sr. No.", "Question", "Option A", "Option B", "Option C", "Option D", "Answer Option", "Time Seconds"]);
  styleHeader(sheet.getRow(1));
  sheet.addRow([1, "5+8=", "13", "12", "11", "10", "A", 15]);
  sheet.addRow([2, "Which PPE is mandatory at site?", "Helmet", "Sports cap", "Slippers", "None", "A", 30]);
